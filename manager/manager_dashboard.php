...
<html lang="en" dir="ltr">
  ...
  <body>
    <nav>
      ...
      <ul>
        <li><a href="recruit_deliveryman.php">Recruit Deliveryman</a></li>
        <li><a href="profile.php">Profile</a></li>
        <li><a href="logout_manager.php">logout</a></li>
        <li><p><?php
      session_start();
  ...
  c.customer_firstName AS 'customer_firstName', c.customer_lastName AS 'customer_lastName', c.customer_phone_number AS 'customer_phone_number', d.deliveryman_firstName AS deliveryman_firstName, d.deliveryman_lastName AS deliveryman_lastName,
  ds.status_name AS status_name, d.deliveryman_phone_number AS deliveryman_phone_number
    ...
    ON d.deliveryman_id = dd.deliveryman_id
   ...
   if(mysqli_num_rows($result)>0) {
     while ($row = mysqli_fetch_assoc($result)) {
           ...
           echo'<tr>
                   ...
                   <td><a href="assigndelivery.php?id='.$row['consignment_id'].'">'.$row['consignment_id'].'</a></td>
